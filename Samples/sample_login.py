...
def login():
    ...
    if username_entry.get()==username and password_entry.get()==password:
        toast = Notification(  app_id="Ninja script", title="Greetings", msg="Keep going",duration="long")
        ...
        toast = Notification(  app_id="Ninja script", title="Alert", msg="Access denied",duration="long")

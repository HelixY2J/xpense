...
def viewwindow():
    ...
    b=customtkinter.CTkButton(gui,text="Exit Window", bg_color="#00D1FF", text_color="#01333E",hover_color="#1785A8",corner_radius=0,border_width=3,border_spacing=3,border_color="#0097C7", font=("Arial", 15),width=10,command=gui.destroy).pack()
...
#Creating 2nd window for main page
    ...
    l1=customtkinter.CTkLabel(root_2,font=("Arial",17),bg_color="#2C2C2C",text_color="#00D1FF",text="Product name").place(x=10,y=120)
    exp_itemname=StringVar()
    e1=Entry(root_2,font=("Arial",15),textvariable=exp_itemname)
    e1.place(x=220,y=155,height=27,width=165)
    l2=customtkinter.CTkLabel(root_2,font=("Arial",17),bg_color="#2C2C2C",text_color="#00D1FF",text="Date(dd-mm-yyyy)").place(x=10,y=160)
    exp_date=StringVar()
    e2=Entry(root_2,font=("Arial",15),textvariable=exp_date)
    e2.place(x=220,y=205,height=27,width=165)
    l3=customtkinter.CTkLabel(root_2,font=("Arial",17),bg_color="#2C2C2C",text_color="#00D1FF",text="Cost of product").place(x=10,y=200)
    exp_cost=StringVar()
    ...
    b1=customtkinter.CTkButton(root_2,text="Add Item",font=("Arial",19),bg_color="#00D1FF", text_color="#01333E",hover_color="#1785A8",corner_radius=0,border_width=3,border_spacing=3,border_color="#0097C7",width=100,command=insertitems).place(x=70,y=250)
    # insert button
    b2=customtkinter.CTkButton(root_2,text="View all items",font=("Arial",19),bg_color="#00D1FF", text_color="#01333E",hover_color="#1785A8",corner_radius=0,border_width=3,border_spacing=3,border_color="#0097C7",width=12,command=viewallitems).place(x=110,y=290)
    b3=customtkinter.CTkButton(root_2,text="Delete with id",font=("Arial",19),bg_color="#00D1FF", text_color="#01333E",hover_color="#1785A8",corner_radius=0,border_width=3,border_spacing=3,border_color="#0097C7",width=150,command=deletewithid).place(x=510,y=180)
    b4=customtkinter.CTkButton(root_2,text="Delete all items",font=("Arial",19),bg_color="#00D1FF", text_color="#01333E",hover_color="#1785A8",corner_radius=0,border_width=3,border_spacing=3,border_color="#0097C7",width=150,command=deletealldata).place(x=510,y=230)
    b5=customtkinter.CTkButton(root_2,text="Search",font=("Arial",19),bg_color="#00D1FF", text_color="#01333E",hover_color="#1785A8",corner_radius=0,border_width=3,border_spacing=3,border_color="#0097C7",width=100,command=search_item).place(x=190,y=250)
    b6=customtkinter.CTkButton(root_2,text="Total spent",font=("Arial",19),bg_color="#00D1FF", text_color="#01333E",hover_color="#1785A8",corner_radius=0,border_width=3,border_spacing=3,border_color="#0097C7",width=150,command=sumofitems).place(x=510,y=280)
    b7=customtkinter.CTkButton(root_2,text="Close app",font=("Arial",19),bg_color="#00D1FF", text_color="#01333E",hover_color="#1785A8",corner_radius=0,border_width=3,border_spacing=3,border_color="#0097C7",width=150,command=endpage).place(x=510,y=570)
    
    #is this required , the greeting scetion ?
    name = "Welcome, " + profilename
    l9=customtkinter.CTkLabel(root_2,width=60,font=("Arial",30,"bold"),bg_color="#2C2C2C", text_color="#59E1FF",text="  "+name).place(x=0,y=61)
...
l1=customtkinter.CTkLabel(root,font=("Arial",18),bg_color='#2C2C2C',text="Username",text_color="#00D1FF").place(x=80,y=185)
l2=customtkinter.CTkLabel(root,font=("Arial",18),bg_color='#2C2C2C',text="Password",text_color="#00D1FF").place(x=80,y=225)
b1=customtkinter.CTkButton(root,text="Login",font=("Arial",19),bg_color="#00D1FF", fg_color="#00D1FF",text_color="#01333E",corner_radius=0,border_width=3,border_spacing=3,border_color="#0097C7",hover_color="#1785A8",width=120,command=login).place(x=130,y=280)
...
b2=customtkinter.CTkButton(root,text="Register",font=("Arial",19),bg_color="#00D1FF", fg_color="#00D1FF",text_color="#01333E",corner_radius=0,border_width=3,border_spacing=3,border_color="#0097C7",hover_color="#1785A8",width=120,command=register).place(x=540,y=330)
...
b3=customtkinter.CTkButton(root,text="Exit Window",font=("Arial",19),bg_color="#00D1FF", text_color="#01333E",hover_color="#1785A8",corner_radius=0,border_width=3,border_spacing=3,border_color="#0097C7",command=root.destroy).place(x=350,y=600)
b4=customtkinter.CTkButton(root,text="Delete all users",font=("Arial",19),bg_color="#00D1FF", text_color="#01333E",hover_color="#1785A8",corner_radius=0,border_width=3,border_spacing=3,border_color="#0097C7",command=deleteallusers).place(x=120,y=460)
b5=customtkinter.CTkButton(root,text="View all users",font=("Arial",19),bg_color="#00D1FF", text_color="#01333E",hover_color="#1785A8",corner_radius=0,border_width=3,border_spacing=3,border_color="#0097C7",command=viewwindow).place(x=120,y=410)

...
def appwindow(username):
    ...
    def endpage():
        ...
        Label(root_2,font=("Arial",40),bg="#2C2C2C",fg="#00D1FF",text="Xpense").place(x=190,y=10)
        ...
        Label(root_2,font=("Arial",35),bg="#2C2C2C",fg="#00D1FF",text="By Group no.9").place(x=500,y=450)
